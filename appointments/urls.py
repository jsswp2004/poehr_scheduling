...
urlpatterns = router.urls + [
    ...
    path('upload/availability/template/', DownloadAvailabilityTemplate.as_view(), name='download-availability-template'),
    path('upload/availability/', UploadAvailabilityCSV.as_view(), name='upload-availability-csv'),
