    ...
    for config in active_configs:
        ...
        for appt in appointments:
            ...
            if (
                ...
                print(
                    f"Skipping appointment {appt.id}: patient={bool(patient)}, phone={bool(patient.phone_number if patient else False)}, already_sent={patient.id in sms_sent_patients if patient else False}"
                )
                continue
            ...
            try:
                ...
                print(
                    f"Appointment details: ID={appt.id}, title='{appt.title}', patient='{patient.first_name} {patient.last_name}'"
                )
