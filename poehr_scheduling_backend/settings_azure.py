...
SECRET_KEY = get_azure_secret('django-secret-key', default=os.environ.get('DJANGO_SECRET_KEY', 'temporary-fallback-key-for-build-only'))
if SECRET_KEY == 'temporary-fallback-key-for-build-only' and os.environ.get('CONTAINER_APP_NAME'):
...
db_password = get_azure_secret('database-password', default=os.environ.get('DB_PASSWORD', ''))
...
REDIS_PASSWORD = get_azure_secret('redis-connection-string', default=os.environ.get('REDIS_PASSWORD', ''))
...
] if os.path.exists(os.path.join(BASE_DIR, 'static', 'frontend')) else []
...
if USE_AZURE_MEDIA and AZURE_ACCOUNT_NAME and (AZURE_ACCOUNT_KEY or os.environ.get('AZURE_STORAGE_CONNECTION_STRING')):
...
EMAIL_HOST_PASSWORD = get_azure_secret('email-host-password', default=os.environ.get('EMAIL_HOST_PASSWORD', ''))

# Twilio configuration
TWILIO_ACCOUNT_SID = os.environ.get('TWILIO_ACCOUNT_SID', '')
TWILIO_AUTH_TOKEN = get_azure_secret('twilio-auth-token', default=os.environ.get('TWILIO_AUTH_TOKEN', ''))
TWILIO_PHONE_NUMBER = os.environ.get('TWILIO_PHONE_NUMBER', '')

# Stripe configuration
STRIPE_PUBLISHABLE_KEY = os.environ.get('STRIPE_PUBLISHABLE_KEY', '')
STRIPE_SECRET_KEY = get_azure_secret('stripe-secret-key', default=os.environ.get('STRIPE_SECRET_KEY', ''))
STRIPE_WEBHOOK_SECRET = get_azure_secret('stripe-webhook-secret', default=os.environ.get('STRIPE_WEBHOOK_SECRET', ''))
...
logger.info(f"Settings loaded. Running in {'Azure Container Apps' if os.environ.get('CONTAINER_APP_NAME') else 'Local'} environment")

# Azure-specific configuration
if AZURE_KEYVAULT_NAME:
    logger.info(f"Using Azure Key Vault: {AZURE_KEYVAULT_NAME}")
else:
    logger.warning("Azure Key Vault not configured - using environment variables for secrets")
