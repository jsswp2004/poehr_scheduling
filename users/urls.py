...
urlpatterns = [
    ...
    path('patients/by-user/<int:user_id>/edit/', PatientUpdateView.as_view(), name='patient-update'),    path('<int:pk>/', UserDetailView.as_view(), name='user-detail'),    path('change-password/', change_password, name='change-password'),
    path('admin-change-password/', admin_change_password, name='admin-change-password'),
    path('reset-patient-password/', reset_patient_password, name='reset-patient-password'),
