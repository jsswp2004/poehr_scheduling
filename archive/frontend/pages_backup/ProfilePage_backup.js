  ...
  const handlePasswordChange = async () => {
    try {
      ...
      const isAdminChangingOtherUser =
        (loggedInUserRole === USER_ROLES.ADMIN || loggedInUserRole === USER_ROLES.SYSTEM_ADMIN) &&
      ...
      >
            ...
            >
              <table
                style={{
                  width: "100%",
                  minWidth:
                    loggedInUserRole === USER_ROLES.SYSTEM_ADMIN ? "800px" : "600px",
              ...
              >
                <thead>
                  <tr style={{ backgroundColor: "#e3f2fd" }}>
                    ...
                    {loggedInUserRole === USER_ROLES.SYSTEM_ADMIN && (
                      <th
                        style={{
                          padding: "8px 12px",
                          textAlign: "left",
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            >
              <Avatar
                src={apiEndpoints.mediaUrl(user.profile_picture)}
                alt="Profile"
                sx={{
                  width: 160,
                  height: 160,
