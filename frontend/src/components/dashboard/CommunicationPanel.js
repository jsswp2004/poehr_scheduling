    ...
    <Box>
      ...
      <Grid container spacing={3} sx={{ height: "100%", minHeight: "600px" }}>
        ...
        <Grid
          ...
          xs={12}
          md={6}
          sx={{ display: "flex", flexDirection: "column", minWidth: "350px" }}
        >
          <Paper
            elevation={2}
            sx={{
          ...
          >
            <Stack spacing={2} sx={{ height: "100%" }}>
              ...
              <Button
                ...
                startIcon={
                  emailSending ? <CircularProgress size={20} /> : <EmailIcon />
                }
                fullWidth
              >
        ...
        >
          ...
          >
            <Stack spacing={2} sx={{ height: "100%" }}>
              ...
              {smsSent && (
                <Alert severity="success">SMS sent successfully!</Alert>
              )}
              ...
              <Button
                ...
                startIcon={
                  smsSending ? <CircularProgress size={20} /> : <SmsIcon />
                }
                fullWidth
              >
