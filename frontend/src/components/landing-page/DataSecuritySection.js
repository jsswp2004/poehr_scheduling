/**
 * Landing page data security section component
 */
import React from 'react';

export const DataSecuritySection = ({ onReadMoreClick }) => {
  return (
      ...
      <div className="data-security-content">
        <div className="data-security-text">
          ...
          <div className="data-security-cta">
            <div className="btn-read-more" onClick={onReadMoreClick} style={{ cursor: 'pointer' }}>
