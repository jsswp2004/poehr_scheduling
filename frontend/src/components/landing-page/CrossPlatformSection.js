/**
 * Landing page cross-platform section component
 */
import React from 'react';

export const CrossPlatformSection = ({ onTryPowerClick }) => {
    return (
            ...
            <div className="efficient-scheduling-content">
                <div className="efficient-scheduling-text">
                    ...
                    <div className="efficient-scheduling-cta">
                        <div className="btn-try-power" onClick={onTryPowerClick} style={{ cursor: 'pointer' }}>
