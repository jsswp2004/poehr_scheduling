/**
 * Landing page final call-to-action section component
 */
import React from 'react';

export const FinalCTASection = ({ onTryPowerClick, onContactSalesClick }) => {
    return (
        <div className="free-trial">
            <div className="heading4">
                ...
                <div className="btn-try2" onClick={onTryPowerClick} style={{ cursor: 'pointer' }}>
                    <div className="try-power-free2">Try POWER free</div>
                </div>
                <div className="on-a-big-team-contact-sales" onClick={onContactSalesClick} style={{ cursor: 'pointer' }}>
