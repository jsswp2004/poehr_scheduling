    ...
    <div className={"landing-page-v-1-desktop-1920-px " + className}>
      ...
      <div className="work-management">
        <div className="content3">
          <div className="headline">
            <div className="text-block">
              <div className="power-scheduling">POWER Scheduling</div>
        ...
        <div className="data-security-content">
          <div className="data-security-text">
            ...
            <p className="data-security-description">
              Your data stays secure with end-to-end encryption and local
              storage options. POWER ensures complete data ownership and
              privacy, giving you full control over your patient information and
              clinic data. HIPAA compliant and trusted by healthcare
      ...
      <div className="pricing-section">
        <div className="pricing-header">
          ...
          <div className="pricing-description">
            Whether you're working solo or with a team, we have a plan that fits
            your needs.
          </div>
        </div>
        ...
        <div className="pricing-cards">
          ...
          <div className="pricing-card popular">
            ...
            <div className="plan-button">
              <div
                className="btn-plan"
                onClick={() => handlePricingClick("clinic")}
                style={{ cursor: "pointer" }}
              >
                Start Free Trial
              </div>
      ...
      <div className="free-trial">
        <div className="heading4">
          ...
          <div
            className="on-a-big-team-contact-sales"
            onClick={handlePricingClick}
            style={{ cursor: "pointer" }}
          >
