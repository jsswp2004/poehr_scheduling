        ...
        <Container maxWidth={false} sx={{ mt: 4, mb: 4, px: 4, height: 'calc(100vh - 100px)' }}>
            ...
            >
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, overflowY: 'auto', maxHeight: '100%' }}>
                    ...
                    <Box sx={{ backgroundColor: '#f9f9f9', p: 3, borderRadius: 2 }}>
                        ...
                        {paymentMethods.length === 0 ? (
                            <Box sx={{ p: 3, backgroundColor: '#ffffff', borderRadius: 1, textAlign: 'center', mb: 2 }}>
                                <Typography variant="body2" color="text.secondary">
                            ...
                            paymentMethods.map((method) => (
                                ...
                                >
                                    <Box>
                                        <Typography variant="body1">{method.type} ending in {method.last4}</Typography>
                                        <Typography variant="body2" color="text.secondary">
                                    ...
                                    <Box sx={{ display: 'flex', gap: 1 }}>
                                        {!method.isDefault && (
                                            <IconButton onClick={() => handleSetDefaultPaymentMethod(method.id)} color="primary" title="Set as Default">
                                                <CheckCircle />
                                            </IconButton>
                                        )}
                                        <IconButton onClick={() => handleDeletePaymentMethod(method.id)} color="error" title="Delete Payment Method">
                                            <Delete />
                                        </IconButton>
                                    </Box>
                                </Box>
                        ...
                        <Button variant="outlined" onClick={() => setAddPaymentOpen(true)} startIcon={<CreditCard />} fullWidth sx={{ mt: 2 }}>
                            Add Payment Method
                        </Button>
                    </Box>
                    ...
                    <Box sx={{ backgroundColor: '#f9f9f9', p: 3, borderRadius: 2 }}>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                            ...
                            <IconButton onClick={handlePrintBillingHistory} color="primary" title="Print Billing History">
                                <Print />
                            </IconButton>
                        </Box>
                                    ...
                                    {billingHistory.length === 0 ? (
                                        ...
                                        billingHistory.map((invoice) => (
                                            <TableRow key={invoice.id}>
                                                ...
                                                <TableCell>
                                                    <Chip label={invoice.status} color={invoice.status === 'Paid' ? 'success' : 'error'} size="small" />
                                                </TableCell>
                                            </TableRow>
                                        ))
                                    )}
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, overflowY: 'auto', maxHeight: '100%' }}>
                    ...
                    <Box sx={{ backgroundColor: '#f9f9f9', p: 3, borderRadius: 2 }}>
                        ...
                        <Button variant="outlined" onClick={() => setChangePlanOpen(true)} startIcon={<Edit />} fullWidth>
                            Change Plan
                        </Button>
                    </Box>
                    ...
                    <Box sx={{ backgroundColor: '#f9f9f9', p: 3, borderRadius: 2 }}>
                        ...
                        <Button variant="contained" color="error" onClick={() => setCancelAccountOpen(true)} startIcon={<Cancel />}>
                            Cancel Account
                        </Button>
                    </Box>
            ...
            <Dialog open={changePlanOpen} onClose={() => setChangePlanOpen(false)} maxWidth="md" fullWidth>
                        ...
                        {planOptions.map((plan) => (
                            <Grid item xs={12} md={4} key={plan.value}>
                                ...
                                >
                                    ...
                                    {currentPlan === plan.value && <Chip label="Current Plan" color="primary" size="small" sx={{ mt: 1 }} />}
                                </Box>
                            </Grid>
                        ))}
                    </Grid>
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleChangePlan} variant="contained" disabled={!selectedPlan || selectedPlan === currentPlan}>
                        Change Plan
                    </Button>
                </DialogActions>
            </Dialog>
            ...
            <Dialog open={cancelAccountOpen} onClose={() => setCancelAccountOpen(false)} maxWidth="sm" fullWidth>
                ...
                <DialogContent>
                    <Alert severity="error" sx={{ mb: 2 }}>
                        <strong>Warning:</strong> Canceling your account will immediately suspend your access to the application. This action cannot be undone.
                    </Alert>
            ...
            <Dialog open={exportDialogOpen} onClose={() => setExportDialogOpen(false)} maxWidth="md" fullWidth>
                                ...
                                <Grid item xs={6} key={key}>
                                    <Button
                                        ...
                                        onClick={() => {
                                            setExportFormData({
                                                ...exportFormData,
                                                include_data: { ...exportFormData.include_data, [key]: !value },
                                            });
                                        }}
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleExportData} variant="contained" disabled={exportLoading || exportFormData.formats.length === 0} startIcon={<CloudDownload />}>
            ...
            <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)} maxWidth="sm" fullWidth>
                ...
                <DialogContent>
                    ...
                    <TextField
                        ...
                        helperText={
                            !!deleteFormData.confirmation_name && deleteFormData.confirmation_name !== accountData?.organization_name
            ...
            <Dialog open={deleteConfirmationOpen} onClose={() => setDeleteConfirmationOpen(false)} maxWidth="sm" fullWidth>
                ...
                <DialogContent>
                    <Alert severity="error" sx={{ mb: 2 }}>
                        You are about to permanently delete <strong>{accountData?.organization_name}</strong>. This is your last chance to cancel.
                    </Alert>
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleFinalDeleteConfirmation} color="error" variant="contained" disabled={deleteLoading} startIcon={<DeleteForever />}>
